...
const layerScrollDistance = () => window.innerHeight * (mobileMode ? 3.5 : data.length);
...
const offsets = mobileMode ? [-118, -62, -5, 54, 112] : [-230, -130, -10, 110, 230];
...
.to(".center-panel",{ scale:mobileMode ? 1.08 : 1.35, duration:0.4, ease:"power2.out" },0.85);
